...
function ReadSysData(InputData::SystemData, strpath::String)
  ...
  name = "PCNIN.csv"
  InputData.DNR_reservoir_inflow_fcst = ReadDataCol!(strpath, name)
  name = "STCIN.csv"
  ...
  Peace_river_inflow_fcst = InputData.WSR_reservoir_inflow_fcst + InputData.DNR_reservoir_inflow_fcst + InputData.STC_reservoir_inflow_fcst
  ...
  InputData.DNR_daily_reservoir_inflow_hist = ReadDataCol!(strpath, name)
